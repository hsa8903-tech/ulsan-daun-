...
try:
    ...
    st.error("오류: 'streamlit-aggrid' 라이브러리가 필요합니다.")
...
<div style="display: flex; align-items: center; padding: 10px 5px; border-bottom: 2px solid #e06000; margin-bottom: 10px;">
    ...
    <h4 style="margin: 0; color: #333; font-size: 1.1rem;">울산다운1차 설비 관리</h4>
</div>
""", unsafe_allow_html=True)

# --- 4. 메인 화면 상단 선택기 (사이드바 대체) ---
...
st.caption("우미건설(주) 울산다운1차 설비팀 전용 현황판")
